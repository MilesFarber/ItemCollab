...
[You can link files too. If the file can't display on a browser window, a download will start.](https://archives.bulbagarden.net/media/upload/6/62/MDBag_Silver_Bow_TDS_Sprite.png)
...
![](https://archives.bulbagarden.net/media/upload/6/62/MDBag_Silver_Bow_TDS_Sprite.png)

This is a l o r g e PNG two lines below.

![](https://archives.bulbagarden.net/media/upload/0/0d/0570Zorua.png)
